    ...
    return (  
        <div className="flex h-[100vh] w-full flex-col bg-gray-100 py-10">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col px-6 py-6 text-center mx-auto my-[40px] bg-white rounded-xl md:w-[500px] w-[350px] shadow-lg" noValidate>
                ...
                {/* Sign in Button*/}
                <button className="max-w-[250px] min-w-[250px] mx-auto px-6 py-5 mb-5 text-sm font-bold leading-none text-white transition duration-300 md:w-96 rounded-2xl hover:bg-green-700 focus:ring-4 focus:ring-purple-100 bg-green-600">Sign In</button>
                ...
                <button className="flex items-center justify-center mx-auto w-[250px] py-4 mb-2 text-sm font-medium rounded-2xl text-gray-900 bg-gray-200 hover:bg-gray-300 focus:ring-4 focus:ring-gray-200">
